...
export function PerfPanel({ onClose }: Props) {
	...
	return (
		<div className="fixed bottom-4 right-4 z-9999 w-80 max-h-[80vh] overflow-hidden rounded-lg border border-border-200/60 bg-orange-50 backdrop-blur shadow-xl">
