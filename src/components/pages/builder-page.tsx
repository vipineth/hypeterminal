				...
				<div className="grid md:grid-cols-2 gap-6">
					...
					<div className="space-y-6">
						<Card>
							<CardHeader>
								...
								<CardDescription>
									Must be signed by your main wallet (not agent/API wallet).
								</CardDescription>
							</CardHeader>
					...
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Estimate builder fee earnings based on trading volume.
							</CardDescription>
						</CardHeader>
							...
							<div className="space-y-4">
								<div className="p-4 bg-muted/30 rounded space-y-3">
									...
									<div className="flex justify-between items-center">
										...
										<span className="font-mono text-lg text-green-500">
											${calculations.perp.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
										</span>
									</div>
								</div>
								...
								<div className="p-4 bg-muted/30 rounded space-y-3">
									...
									<div className="flex justify-between items-center">
										...
										<span className="font-mono text-lg text-green-500">
											${calculations.spot.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
										</span>
									</div>
								</div>
							</div>
