	...
	return (
		<div className="h-full min-h-0">
			...
			>
				...
				<ResizableHandle className="bg-stroke-weak/40 data-[resize-handle-state=hover]:bg-fill-brand-strong/30 data-[resize-handle-state=drag]:bg-fill-brand-strong/50" />
